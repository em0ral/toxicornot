// Editorial content for the toxicornot.ai Guides section.
// Each guide is rendered server-side at /guides/[slug] and listed at /guides.
// Keep entries data-only so the whole section can be swapped when cloning this
// codebase for another ornot.ai site.
...
export const guides = [
  {
    ...
    sections: [
      ...
      {
        heading: "Common gaslighting phrases",
        body: [
      ...
      {
        heading: "Signs you may be experiencing it",
        body: [
...

  {
    ...
    related: ["recognizing-manipulation", "what-is-gaslighting"],
  },

  {
    slug: "recognizing-manipulation",
    emoji: "🎭",
    ...
    sections: [
      {
        ...
        list: [
          "Guilt-tripping — making you feel responsible for their feelings or choices",
          "Deflection — turning every concern you raise back onto you",
          "The silent treatment — using withdrawal and stonewalling as punishment",
          "Moving the goalposts — changing the rules so you can never quite succeed",
          "Playing the victim — reframing themselves as the wronged party in every conflict",
          "Love withdrawal — making affection conditional on compliance",
          "Triangulation — bringing in a third person to pressure or compare you",
          "DARVO — Deny, Attack, and Reverse Victim and Offender when confronted",
          "Negging — backhanded compliments that chip away at your confidence",
          "Future faking — promising change or commitment they never intend to deliver",
        ],
      },
      {
      ...
      {
        heading: "How to respond without getting pulled in",
        body: [
    ...
    related: ["what-is-gaslighting", "how-to-respond-to-toxic-messages"],
  },

  {
    slug: "healthy-vs-toxic-communication",
    emoji: "⚖️",
  ...
  {
    slug: "how-to-respond-to-toxic-messages",
    emoji: "🛡️",
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "De-escalate — lower the temperature without conceding the point",
          "Seek clarity — ask a direct question instead of assuming intent",
          "Disengage — decline to participate in a fight you can't win",
          "Exit — end the conversation, or the relationship, when it's unsafe or unproductive",
        ],
      },
      {
